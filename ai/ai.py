...
class Searcher:
    ...
    def search(self, pos, history=()):
        ...
        for depth in range(1, self.depth): #DEPTH: default 1000
...
class AI:
    ...
    def main(self):
        while True:
            self.print_pos(self.hist[-1])
            move = None
            while move not in self.hist[-1].gen_moves():
            ...
            self.print_pos(self.hist[-1].rotate())
            ...
            print("My move:", self.render(119-move[0]) + self.render(119-move[1]))
            self.hist.append(self.hist[-1].move(move))
